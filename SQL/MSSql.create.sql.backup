...
CREATE INDEX ПоказаниеПУ_IПриборУчета_m0 on [ПоказаниеПУ] ([ПриборУчета_m0])
 ...
 ALTER TABLE [ПомещениеСобственника] ADD CONSTRAINT [ПомещениеСобственника_FПомещение_0] FOREIGN KEY ([Помещение_m0]) REFERENCES [Помещение]
CREATE INDEX ПомещениеСобственника_IПомещение_m0 on [ПомещениеСобственника] ([Помещение_m0])

 ALTER TABLE [ПомещениеСобственника] ADD CONSTRAINT [ПомещениеСобственника_FСобственник_0] FOREIGN KEY ([Собственник_m0]) REFERENCES [Собственник]
CREATE INDEX ПомещениеСобственника_IСобственник_m0 on [ПомещениеСобственника] ([Собственник_m0])

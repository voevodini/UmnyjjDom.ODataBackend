...
CREATE TABLE [Дом] (
	 ...
	 [УК_m0] UNIQUEIDENTIFIER  NOT NULL,
...
CREATE INDEX Помещение_IСобственник_m0 on [Помещение] ([Собственник_m0])
 ...
 ALTER TABLE [Дом] ADD CONSTRAINT [Дом_FУК_0] FOREIGN KEY ([УК_m0]) REFERENCES [УК]
CREATE INDEX Дом_IУК_m0 on [Дом] ([УК_m0])

 ALTER TABLE [Сотрудник] ADD CONSTRAINT [Сотрудник_FУК_0] FOREIGN KEY ([УК_m0]) REFERENCES [УК]
CREATE INDEX Сотрудник_IУК_m0 on [Сотрудник] ([УК_m0])
...
CREATE INDEX Квитанция_IПомещение_m0 on [Квитанция] ([Помещение_m0])
 ...
 ALTER TABLE [Квитанция] ADD CONSTRAINT [Квитанция_FУК_0] FOREIGN KEY ([УК_m0]) REFERENCES [УК]
CREATE INDEX Квитанция_IУК_m0 on [Квитанция] ([УК_m0])
